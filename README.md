# Project Title
Project name: School Billing System for Administration<br/>

#Installation Process
Code Blocks downloaded from: http://www.codeblocks.org/downloads/26 .Then  run the download software and follw the instruction and accept the default option. Then verify the compilers and dibugger path.<br/>
...
#Built with
Bluit with C programming and The software name is Code-Blocks<br/>
...
iv. Computer programming with Tamim Shahriar Shubin.<br/>
